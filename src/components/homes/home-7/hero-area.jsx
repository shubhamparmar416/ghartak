...
const hero_content = {
    ...
    info: <> We are dedicated to delivering cutting-edge IT solutions tailored to your needs. With a focus on innovation, we empower businesses to thrive in the digital era.</>, 
}
                        ...
                        <div className="row">
                            <div className="col-xl-5 col-lg-6">
                                <div className="slider-text">
                                    ...
                                    <Link href="/contact" className="x-btn wow fadeInUp animated" data-wow-delay="1.5s">Let's Talk</Link>
                                </div>
                            </div>
