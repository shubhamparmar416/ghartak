...
const PageTitleArea = () => {
  return (
    <>
      ...
      <div
        className="page-title-area pos-relative gray-bg pt-150 pb-120 fix mb-50"
      ...
      {/* <!-- page-title-area start --> */}
      <div
        className="page-title-area pos-relative gray-bg  fix mb-50"
      ...
      {/* <!-- page-title-area start --> */}
      <div
        className="page-title-area pos-relative gray-bg pt-150 pb-150 fix mb-50"
        style={{ backgroundImage: `url(/assets/img/bg/page-title-bg-2.jpg)` }}
      >
        <div className="page-title-bar-overlay"></div>
        <div className="shape-slider">
          <img
            ...
            src="assets/img/shape/shape2.png"
            alt="theme-pure"
          />
          <img
          ...
          <img
            ...
            src="assets/img/shape/shape-sq.png"
            alt="theme-pure"
          />
          <img
            className="shape shape-6"
            src="assets/img/shape/shape-c-2.png"
            alt="theme-pure"
          />
        </div>
        <div className="container">
