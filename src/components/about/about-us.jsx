...
const about_content = {
  ...
  sm_des_1: (
    <>
      Divide there our divide fifth creepeth second which multiply evening fill
      so abundantly let upon there saw light behold he bearing hath morning over
      lesser image said. Whales and second.
    </>
  ),
  sm_des_2: (
    <>
      Divide there our divide fifth creepeth second which multiply so evening
      fill abundantly let upon there saw light behold he bearing inhath morning
      on lesser image said. Whales and second. Divide man poe there our divide
      fifh creepeth second which multiply evening
    </>
  ),
};
